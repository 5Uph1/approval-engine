...
export default function RequestDetailPage() {
  ...
  // Approve / Reject dsb. sesuai action yang diberikan API untuk stage ini
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea
                  id="comment"
                  rows={3}
                  placeholder="Berikan komentar atau alasan..."
                  value={comment}
              ...
              <div className="flex flex-wrap justify-end gap-3">
                {actions.map((action) => (
                  <Button
                    key={action.code}
                    variant={action.isReject ? "destructive" : "default"}
                    disabled={busy !== null}
